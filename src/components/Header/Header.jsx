...
export default function Header() {
  return (
    <header className={`${styles.test}`}>
      <div className="text-center bg-black lg:flex items-center py-2.5">
        <div className="custom-container lg:grid lg:grid-flow-col px-[7%] lg:px-[5%] md:px-[3%]">
          <div className="hidden lg:flex"></div>
          <div className="text-center text-white">
            <p className={`${styles.signupdis}`}>
      ...
      <nav className="py-3 lg:py-6 ">
        <div className="custom-container px-[7%] lg:px-[5%] md:px-[3%] flex justify-between  items-center">
          <div className="flex items-center justify-between gap-x-4 lg:gap-x-[40px] xl:gap-x-[46px] 2xl:gap-x-[70px]">
           ...
           <a href="/"> <img src="images/SHOP-CO.png" alt="" /></a>  
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className=" lg:flex space-x-4 lg:space-x-6 2xl:space-x-8 hidden">
                <li>
          ...
          <div className="flex gap-x-4 lg:gap-x-[40px] xl:gap-x-[46px] 2xl:gap-x-[70px]">
            <div class=" flex items-center lg:bg-gray-100 rounded-[16px] p-0 lg:px-3 lg:py-2 width lg:w-[285px] xl:w-[470px] 2xl:w-[610px]">
              <svg
                class="w-5 h-5 text-black-500 lg:text-gray-500 "
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <input
                ...
                class="hidden lg:block bg-transparent outline-none ml-3 w-full placeholder-gray-400 text-sm"
              />
            </div>
